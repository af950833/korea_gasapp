...
- 2026/05/11 V1.0.2 원격 검침 후 센서값 바로 업데이트
- 2026/05/13 V1.1.0 인증이 풀리는 경우 재인증 자동 요청
- 2026/05/14 V1.1.1 API 접속시 3회까지 Retry
- 2026/05/14 V1.1.5 인증 풀림 문제 해결(서버 webVersion 변경 대응)
- 2026/05/16 V1.1.6 사용 중 인증 풀림 문제 해결(서버 webVersion 변경 대응)
